        ...
        <div css={s.content}>
          <div css={s.text}>
            <span>
              <b>첫 번째, </b>
              <br />
              인터랙티브한 페이지를 개발하는 것을 좋아하며 사용자에게 편리한
              UI를 제공하는 웹을 만들기 위해 노력합니다.
            </span>
            <br />
            <span>
              <b>두 번째, </b>
              <br />
              새롭게 배운 기술을 업무에 적용하여 좀 더 나은 서비스를 구축해
              나아가는것에 보람을 느낍니다.
            </span>
            <br />
            <span>
              <b>세 번째, </b>
              <br />
              팀프로젝트를 통해 함께 의견을 나누고 고민하며 프로젝트의 시작과
              끝을 맺은 경험이 있습니다.
            </span>
            <br />
            <span>
              ...
              느끼고, <br /> 그 과정에서 지속적으로 학습하고 성장할 수 있는
